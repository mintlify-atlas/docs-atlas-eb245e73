...
Place `CLAUDE.md` in your project root. Claude will read it at the start of each session.
...
If both `CLAUDE.md` and `AGENTS.md` exist, agents read both (with CLAUDE.md taking precedence for Claude-specific settings).
